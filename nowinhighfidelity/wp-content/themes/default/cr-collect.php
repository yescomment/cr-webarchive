...
<div id="container" class="clearfix">
	<div id="leftbar">
			  <div id="local">
			  <ul id="local-nav"> 
					<li><a href="/category/calendar/">News</a></li>
					<li><a href="/category/events/">Events</a></li>
					<li><a href="/category/bulletin-board/">Blog</a></li>
					<li><a href="<?php bloginfo('template_directory'); ?>/calendar/">Calendar View2</a></li>
				</ul>
				</div>
