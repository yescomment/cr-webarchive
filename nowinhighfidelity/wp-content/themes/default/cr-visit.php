...
<div id="container" class="clearfix">
	<div id="leftbar">
			  <div id="local">
			  <ul id="local-nav"> 
					<li><a href="/nowinhighfidelity/admission">Admission & Group Visits</a></a></li>
					<li><a href="/nowinhighfidelity/directions">Directions</a></li>
					<li><a href="/nowinhighfidelity/floorplans">Floor Plans</a></li>
				</ul>
				</div>
