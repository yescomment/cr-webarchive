...
function edShowButton(button, i) {
	if (button.id == 'ed_img') {
		document.write('<td width="24" class="quicktags"><input type="button" id="' + button.id + '" class="ed_button" onclick="edInsertImage(edCanvas);" value="' + button.display + '" /></td>');
	}
	else if (button.id == 'ed_link') {
		document.write('<td width="24" class="quicktags"><input type="button" id="' + button.id + '" class="ed_button" onclick="edInsertLink(edCanvas, ' + i + ');" value="' + button.display + '" /></td>');
	}
	else {
		document.write('<td width="24" class="quicktags"><input type="button" id="' + button.id + '" class="ed_button" onclick="edInsertTag(edCanvas, ' + i + ');" value="' + button.display + '" /></td>');
	}
}
...
function edToolbar() {
	...
	document.write('<td width="24" class="quicktags"><input type="button" id="ed_close" class="ed_button" onclick="edCloseAllTags();" value="Close Tags" /></td>');
	document.write('<td width="24" class="quicktags"><input type="button" id="ed_spell" class="ed_button" onclick="edSpell(edCanvas);" value="Dict" /></td>');
//	edShowLinks();
	document.write('</div>');
}
